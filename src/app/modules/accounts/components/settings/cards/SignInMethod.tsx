...
const SignInMethod: React.FC = () => {
  ...
  const formik1 = useFormik<IUpdateEmail>({
    ...
    onSubmit: (values) => {
      ...
      axios.post<IUpdateEmail>('https://localhost:7295/WeatherForecast', Signin).then((result) => {
        setEmailUpdateData(result.data)
        setLoading1(false)
  ...
  const formik2 = useFormik<IUpdatePassword>({
    ...
    onSubmit: (values) => {
      ...
      axios.post<IUpdatePassword>('https://localhost:7295/WeatherForecast', pass).then((result) => {
        setPasswordUpdateData(result.data)
        setLoading2(false)
