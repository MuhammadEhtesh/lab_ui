...
const NewRetailer = () => {
  ...
  const notify = () => toast("Retailer saved successfully.");
  const handleSubmit = (e: any) => {
    ...
    axios.post('http://localhost:8080/addretailer', retailer).then(res =>  {
      notify();
      e.target.reset();
      setPreviewImage('');
      ...
      <div className='card mb-5 mb-xl-10'>
        ...
        >
          <div className='card-title m-0'>
            <h3 className='fw-bolder m-0'>New Retailer</h3>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} noValidate className='form'>
            <div className='card-body border-top p-9'>
              <div className='row mb-6'>
                <label className='col-lg-4 col-form-label required fw-bold fs-6'>Retailer Name</label>
              ...
              <div className='row mb-6'>
                ...
                <div className='col-lg-8 fv-row'>
                  <input
                    type='text'
                    className='form-control form-control-lg form-control-solid'
                    placeholder='Retailer Description'
                    name='description'
                  />
                </div>
              </div>
              ...
              <div className='row mb-6'>
                <label className='col-lg-4 col-form-label fw-bold fs-6'>
                  <span className='required'>Retailer Image</span>
                </label>
